            ...
            <div className="col-md-5 pt-4">
              <div className="boxProfile p-4">
                <div className="row">
                  <div className="col-md-3">
                    <div className="boxImgProfile">
                      <img src="https://images.unsplash.com/photo-1573865526739-10659fec78a5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=300&q=80" alt="" className="avatar" />
                    </div>

                  </div>
                  <div className="col-md-9">
                    <div className="boxUserNameDash">
                      <h2>Catia</h2> <i><img src="image/Edit.svg" className="img-fluid" alt="" /></i>
                    </div>
                    <hr className="mt-3" />
                    <ul className="datPet pt-4">
                      <li>
